...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            {/* Featured Jobs */}
            <div className="bg-[#f0f6ff] py-20 relative scroll-animate" style={{ opacity: 0 }}>
                        ...
                        <div className="flex justify-center gap-4 mt-8 flex-wrap">
                            {['All', 'Trending', 'Design', 'Marketing', 'Health'].map((tab) => (
                                <button 
                                    ...
                                    className={`px-6 py-2 rounded-full text-sm font-medium transition-colors ${activeTab === tab ? 'bg-primary text-white shadow-md' : 'bg-[#e2eaf8] text-gray-600 hover:bg-white'}`}
                                >
                                    {tab}
                                </button>
                            ))}
                            ...
                            filteredJobs.map((job, index) => (
                                <Link to={`/jobs/${job._id}`} key={job._id || index} className="block bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-all group relative">
                                    <div className="flex items-start gap-4 mb-6">
                                        <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl flex-shrink-0 ${job.logoColor || 'bg-blue-600'}`}>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="px-4 py-1.5 rounded-full text-xs font-semibold bg-blue-50 text-blue-600">
                                            {job.type || 'Full Time'}
                                        </span>
            ...
            <div className="py-20 bg-white overflow-hidden scroll-animate" style={{ opacity: 0 }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
            ...
            <div className="bg-[#1a1a2e] text-white pt-12 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-xs mb-4">
                    <p>© 2025 Job Chaahiye | All rights reserved</p>
