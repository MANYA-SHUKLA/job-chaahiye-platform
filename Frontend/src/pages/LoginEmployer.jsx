...
const LoginEmployer = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            {/* Top Company Hiring */}
            <div className="py-12 bg-white scroll-animate [mask-image:_linear-gradient(to_right,_transparent_0,_white_128px,white_calc(100%-128px),_transparent_100%)]" style={{ opacity: 0 }}>
